...
const Color _micSurface = Color(0xFF111111);
const Color _micElevated = Color(0xFF1A1A1A);
const Color _micBorder = Color(0xFF2A2A2A);
const Color _micPrimaryText = Colors.white;
const Color _micAccent = Color(0xFFFF69B4);
const Color _micAccentDeep = Color(0xFF8B5CF6);
          ...
          child: Column(
            ...
            children: [
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: _isListening
                            ? const RadialGradient(
                                colors: [_micAccent, _micAccentDeep],
                                stops: [0.3, 1.0],
                              )
                            : null,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color:
                      _isListening ? _micAccent : _micBorder,
